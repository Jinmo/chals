...
void my_server_complete_report (
    MyServer *object,
    GDBusMethodInvocation *invocation,
...
gboolean my_server_call_report_finish (
    MyServer *proxy,
    gchar **out_response,
    GAsyncResult *res,
    GError **error);

gboolean my_server_call_report_sync (
    MyServer *proxy,
    const gchar *arg_reporter,
    gchar **out_response,
    GCancellable *cancellable,
